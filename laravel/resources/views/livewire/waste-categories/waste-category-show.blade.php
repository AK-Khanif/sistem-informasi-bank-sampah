        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-semibold">Detail Kategori Sampah</h2>
                    <div class="flex gap-2">
                        @can('update', $wasteCategory)
                            <a href="{{ route('waste-categories.edit', $wasteCategory) }}" wire:navigate
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-900">{{ $wasteCategory->code }}</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-900">{{ $wasteCategory->name }}</p>
                    </div>
                    <div>
                        <h3 class="text-sm font-medium text-gray-500">Jumlah Jenis Sampah</h3>
                        <p class="mt-1 text-sm text-gray-900">{{ $wasteTypesCount }}</p>
                    </div>
                    <div class="sm:col-span-2">
                        <h3 class="text-sm font-medium text-gray-500">Deskripsi</h3>
                        <p class="mt-1 text-sm text-gray-900">{{ $wasteCategory->description ?? '-' }}</p>
                    </div>
                    <div>
                        <h3 class="text-sm font-medium text-gray-500">Tanggal Dibuat</h3>
                        <p class="mt-1 text-sm text-gray-900">{{ $wasteCategory->created_at->format('d-m-Y') }}</p>
                    </div>
                    <div>
                        <h3 class="text-sm font-medium text-gray-500">Terakhir Diperbarui</h3>
                        <p class="mt-1 text-sm text-gray-900">{{ $wasteCategory->updated_at->format('d-m-Y') }}</p>
                    </div>
                </div>
