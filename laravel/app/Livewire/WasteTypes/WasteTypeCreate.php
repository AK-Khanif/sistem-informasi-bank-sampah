...
class WasteTypeCreate extends Component
{
    ...
    public function rules(): array
    {
        return [
            ...
            'code' => 'required|string|max:10|unique:waste_types,code',
            'name' => [
                'required',
                'string',
                'max:100',
                Rule::unique('waste_types', 'name')->where('waste_category_id', $this->waste_category_id),
            ],
    ...
    public function save(): void
    {
        ...
        session()->flash('message', 'Data jenis sampah berhasil disimpan.');
    ...
    public function render()
    {
        ...
        return view('livewire.waste-types.waste-type-create', [
